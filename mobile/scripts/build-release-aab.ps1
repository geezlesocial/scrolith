...
$OutDir = Join-Path $MobileRoot 'release-artifacts\android-1.1.57'
$VersionCode = 67
$VersionName = '1.1.57'
...
$meta = @{
  ...
  phase = 'azure-media-delivery-mobile-refresh'
  targetSdk = 36
  compileSdk = 36
  minSdk = 24
  productionBackendRevision = 'ca-scrolith-backend--media-be382acc'
  productionFrontendRevision = 'ca-scrolith-frontend--media-d88d4648'
