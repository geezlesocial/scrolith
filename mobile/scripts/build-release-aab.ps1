...
$OutDir = Join-Path $MobileRoot 'release-artifacts\android-1.1.45'
$VersionCode = 55
$VersionName = '1.1.45'
...
$meta = @{
  ...
  phase = 'simultaneous-video-autoplay-stability-performance'
  targetSdk = 36
  compileSdk = 36
  minSdk = 24
  productionBackendRevision = 'scrolith-backend-videoauto0726'
  productionFrontendRevision = 'scrolith-frontend-videoauto0726'
