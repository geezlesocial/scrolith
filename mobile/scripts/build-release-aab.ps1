...
$OutDir = Join-Path $MobileRoot 'release-artifacts\android-1.3.11'
$VersionCode = 122
$VersionName = '1.3.11'
...
$RelativeReleaseWebDir = 'release-artifacts/android-1.3.11/web-dist'
...
$meta = @{
  ...
  phase = 'guest-passkeys-post-identity-phase3'
  targetSdk = 36
  compileSdk = 36
  minSdk = 24
