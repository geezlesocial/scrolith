...
$OutDir = Join-Path $MobileRoot 'release-artifacts\android-1.1.47'
$VersionCode = 57
$VersionName = '1.1.47'
...
$meta = @{
  ...
  phase = 'enterprise-call-control-colors-minimized-overlay'
  targetSdk = 36
  compileSdk = 36
  minSdk = 24
  productionBackendRevision = 'scrolith-backend-videoauto0726'
  productionFrontendRevision = 'scrolith-frontend-callcontrols0726'
