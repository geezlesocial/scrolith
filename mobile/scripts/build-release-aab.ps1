...
$OutDir = Join-Path $MobileRoot 'release-artifacts\android-1.1.49'
$VersionCode = 59
$VersionName = '1.1.49'
...
$meta = @{
  ...
  phase = 'call-audio-overlay-network-hardening'
  targetSdk = 36
  compileSdk = 36
  minSdk = 24
  productionBackendRevision = 'scrolith-backend-antom0728'
  productionFrontendRevision = 'scrolith-frontend-callhard0728'
