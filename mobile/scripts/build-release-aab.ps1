...
$OutDir = Join-Path $MobileRoot 'release-artifacts\android-1.1.43'
$VersionCode = 53
$VersionName = '1.1.43'
...
$meta = @{
  ...
  phase = 'video-media-storage-hardening'
  targetSdk = 36
  compileSdk = 36
  minSdk = 24
  productionBackendRevision = 'scrolith-backend-videomedia2'
  productionFrontendRevision = 'scrolith-frontend-videomedia0726'
