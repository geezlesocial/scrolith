...
$OutDir = Join-Path $MobileRoot 'release-artifacts\android-1.1.56'
$VersionCode = 66
$VersionName = '1.1.56'
...
$meta = @{
  ...
  phase = 'company-linked-profile-experience'
  targetSdk = 36
  compileSdk = 36
  minSdk = 24
  productionBackendRevision = 'scrolith-backend-companyexp-bcd47eec'
  productionFrontendRevision = 'scrolith-frontend-companyexp-6252fd85'
