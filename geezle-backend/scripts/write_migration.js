...
ALTER TABLE IF EXISTS "UserFollow"
  ADD CONSTRAINT "UserFollow_follower_fkey" FOREIGN KEY ("followerId") REFERENCES "User"("id") ON DELETE CASCADE;
ALTER TABLE IF EXISTS "UserFollow"
  ADD CONSTRAINT "UserFollow_followee_fkey" FOREIGN KEY ("followeeId") REFERENCES "User"("id") ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS "Notification"
  ADD CONSTRAINT "Notification_user_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE;
ALTER TABLE IF EXISTS "Notification"
  ADD CONSTRAINT "Notification_actor_fkey" FOREIGN KEY ("actorId") REFERENCES "User"("id") ON DELETE SET NULL;
