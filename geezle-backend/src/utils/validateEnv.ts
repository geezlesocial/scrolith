...
const OPTIONAL_KEYS: EnvKey[] = [
  ...
  { key: 'SCROLITH_PASSKEYS_ENABLED', description: 'Enable WebAuthn/passkey authentication and account management (default false)' },
  { key: 'PASSKEY_RP_ID', description: 'WebAuthn relying-party ID (default scrolith.com)' },
  { key: 'PASSKEY_RP_NAME', description: 'WebAuthn relying-party display name (default Scrolith)' },
  { key: 'PASSKEY_ALLOWED_ORIGINS', description: 'Comma-separated HTTPS origins allowed for WebAuthn ceremonies' },
  { key: 'PASSKEY_CHALLENGE_TTL_MS', description: 'Passkey challenge lifetime, clamped to 30 seconds–5 minutes' },
