...
import hiringRecommendationsAdminRoutes from './hiring-recommendations.routes';
import scrolithMatchAdminRoutes from './scrolith-match.routes';
...
import mediaRecoveryRoutes from './media-recovery.routes';
...
import messagingGroupsAdminRoutes from './messaging-groups.routes';
import notificationOpsRoutes from './notification-ops.routes';
import scrolithaAiAdminRoutes from './scrolitha-ai.routes';
...
router.use('/messaging-groups', messagingGroupsAdminRoutes);
router.use('/notifications', notificationOpsRoutes);
router.use('/ai', scrolithaAiAdminRoutes);
...
router.use('/hiring-recommendations', hiringRecommendationsAdminRoutes);
router.use('/scrolith-match', scrolithMatchAdminRoutes);
...
router.use('/media-recovery', mediaRecoveryRoutes);
