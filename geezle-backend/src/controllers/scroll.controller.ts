...
/**
 * Video-only Scroll search. This deliberately reuses the feed visibility,
 * block, hidden-item, and payload rules instead of becoming a second global
 * search or authorization layer.
