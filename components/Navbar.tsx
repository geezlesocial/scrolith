        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <div className="hidden md:flex space-x-6 mr-4 items-center">
                ...
                <Link to="/community/gcoin" className="text-gray-500 hover:text-gray-900 text-sm font-medium flex items-center">Gcoin</Link>
                <Link to="/community/my-ads" className="text-gray-500 hover:text-gray-900 text-sm font-medium flex items-center">My Ads</Link>
            </div>

            {/* Mobile hamburger */}
            <div className="md:hidden mr-2 flex items-center">
                <button aria-controls="mobile-panel" onClick={() => setMobileOpen(!mobileOpen)} aria-expanded={mobileOpen} className="p-2 rounded-md text-gray-600 hover:bg-gray-100" aria-label="Open mobile menu">
