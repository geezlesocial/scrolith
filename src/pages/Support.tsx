    ...
    const handleTrack = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (ticket) {
                ...
                showNotification('error', 'Not Found', 'No ticket found with this tracking code.');
                setTrackedTicket(null);
            }
        } catch (error) {
            showNotification('error', 'Error', 'Failed to track ticket.');
        } finally {
            setIsSubmitting(false);
        }
    };
                            ...
                            createdTicket ? (
                                <div className="text-center py-12">
                                    ...
                                    <div className="bg-gray-100 py-3 px-6 rounded-lg text-xl font-mono font-bold text-gray-800 inline-block mb-8 border border-gray-200">
                                        {createdTicket.tracking_code}
                                    </div>
                                    <p className="text-sm text-gray-500 max-w-md mx-auto mb-8">
                                        Use this code to track the status of your request at any time.
                                    </p>
                                        <button 
                                        onClick={() => { setTrackingCodeInput(createdTicket.tracking_code || ''); setCreatedTicket(null); setActiveTab('track'); }}
                                            ...
                                            <div className="flex justify-between items-start mt-6 pt-6 border-t border-gray-100">
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-3 mt-1">
                                                        <span className="text-sm text-gray-500">#{trackedTicket.tracking_code || trackedTicket.id}</span>
