...
export class MatchingService {
    ...
    constructor() {
        ...
        this.client = new GoogleGenAI({ apiKey: providerConfig.api_key });
        ...
        this.config = {
            ...
            weights: {
                ...
                response_time: 0.10,// 10% - mapped from 'Availability'
                budget_fit: 0.10    // 10%
            ...
            try {
                ...
                if (finalScore > 0) {
                    matches.push({
                        ...
                        match_reason: result.matchReason || `Strong skill match in ${job.tags[0]}`
                    });
                }
