...
export const MarketService = {
    getLTVPredictions: async (): Promise<LTVMetric[]> => {
        return new Promise(resolve => setTimeout(() => resolve([
            { user_id: 'u1', user_name: 'Top Agency', role: 'freelancer' as any, predicted_ltv: 150000, confidence_score: 92, revenue_velocity: 'High', churn_risk: 5, next_action: 'Offer Pro Plan' },
            { user_id: 'u2', user_name: 'Startup Inc', role: 'employer' as any, predicted_ltv: 45000, confidence_score: 85, revenue_velocity: 'Medium', churn_risk: 15, next_action: 'Send Case Studies' },
            { user_id: 'u3', user_name: 'New Dev', role: 'freelancer' as any, predicted_ltv: 5000, confidence_score: 60, revenue_velocity: 'Low', churn_risk: 45, next_action: 'Suggest Upskilling' },
        ]), 600));
    },
