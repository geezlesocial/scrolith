    ...
    >
      ...
      >
        ...
        <div id="scroll-search-results" role="listbox" aria-label="Scroll search results" className="min-h-0 flex-1 overflow-y-auto p-4 sm:p-6">
          ...
          {!error && !loading && normalizedQuery.length >= 2 && results.length === 0 ? <p className="py-12 text-center text-sm text-white/60">No Scroll videos found for &quot;{normalizedQuery}&quot;.</p> : null}
