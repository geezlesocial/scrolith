...
const ThreadDetail = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto pb-12">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-gray-400 text-sm flex items-center">
                                <Calendar className="w-3.5 h-3.5 mr-1" /> {new Date(thread.createdAt || thread.created_at || new Date()).toLocaleDateString()}
                            </span>
                        </div>
            ...
            {/* Comments Section */}
            {(thread.status === 'locked' || thread.isLocked || thread.is_locked) ? (
