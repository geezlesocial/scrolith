            ...
            <div className="h-full flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-xl bg-white p-8">
              {isUploading ? (
                ...
                <>
                  ...
                  <label className="bg-blue-600 text-white px-6 py-3 rounded-lg font-bold cursor-pointer hover:bg-blue-700 transition shadow-sm flex items-center">
