...
export const SocketProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const handlers: Array<{ ev: string; fn: (...args: any[]) => void }> = [
      ...
      { ev: 'scrolitha:request_started', fn: forward('scrolitha:request_started') },
      { ev: 'scrolitha:response_created', fn: forward('scrolitha:response_created') },
      { ev: 'scrolitha:response_failed', fn: forward('scrolitha:response_failed') },
