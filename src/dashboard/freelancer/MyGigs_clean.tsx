        ...
        },
        {
            ...
            render: (value: any, gig: Gig) => (
                <div className="text-sm">
                    <div>Views: <span className="font-medium">{gig.performance.views}</span></div>
                    <div>Clicks: <span className="font-medium">{gig.performance.clicks}</span></div>
                    <div>Orders: <span className="font-medium">{gig.performance.orders}</span></div>
                </div>
            )
        },
        {
