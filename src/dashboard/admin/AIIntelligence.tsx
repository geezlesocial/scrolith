...
const AIOverview = () => {
    ...
    useEffect(() => {
        AdminService.getAIAnalytics().then(data => {
            ...
            console.log('🔄 Transformed AI Analytics:', transformedData);
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <p className="text-2xl font-bold text-gray-900 mt-1">
                        {formatPrice(stats.costEstimate || 0)}
                    </p>
                ...
                <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <p className="text-2xl font-bold text-red-600 mt-1">
                        {stats.safetyStats?.spamTriggers || 0}
                    </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <div className="space-y-4">
                        {(stats.topRoles || []).map((role: any, idx: number) => (
                            <div key={idx}>
                                <div className="flex justify-between items-center mb-1 text-sm">
                                    <span className="text-gray-700 capitalize">{role.role || 'Unknown'}</span>
                                ...
                                <div className="w-full bg-gray-100 rounded-full h-2">
                                    <div 
                                        ...
                                        style={{ 
                                            width: `${((role.count || 0) / Math.max(stats.totalConversations || 1, 1)) * 100}%` 
                                        }}
                                    ></div>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <p className="text-3xl font-bold">
                                {stats.conversionImpact?.aiGigsCreated || 0}
                            </p>
                        ...
                        <div>
                            ...
                            <p className="text-3xl font-bold text-green-400">
                                +{stats.conversionImpact?.aiHireRate || 0}%
                            </p>
                        ...
                        <div className="col-span-2 pt-4 border-t border-indigo-700">
                            ...
                            <p className="text-2xl font-bold text-white">
                                {formatPrice(stats.conversionImpact?.revenueUplift || 0)}
                            </p>
                        </div>
                    </div>
                </div>
