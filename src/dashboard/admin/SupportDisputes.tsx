                             ...
                             {categories.map(cat => (
                                 <tr key={cat.id} className="hover:bg-gray-50">
                                     ...
                                     <td className="px-6 py-4">
                                        <span className={`px-2 py-1 rounded text-xs font-bold ${(cat.isActive ?? cat.is_active) ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'}`}>
                                             {(cat.isActive ?? cat.is_active) ? 'Active' : 'Disabled'}
                                        </span>
                                     </td>
