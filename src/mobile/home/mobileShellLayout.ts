...
export const MOBILE_HEADER_CONTAINER_CLASS =
  'mx-auto flex w-full min-w-0 max-w-[980px] items-center gap-2.5 px-3 py-2 sm:px-4 md:px-5';
...
export const MOBILE_BOTTOM_NAV_CONTAINER_CLASS =
  'mx-auto flex w-full max-w-[760px] items-stretch justify-around gap-0.5 px-1.5 py-1.5 sm:px-3';
/** Shell main content padding: header + bottom nav + safe areas (next-gen chrome). */
export const MOBILE_SHELL_MAIN_PAD_CLASS =
  'pt-[calc(3.5rem+env(safe-area-inset-top,0px))] pb-[calc(4.25rem+env(safe-area-inset-bottom,0px))]';
